...
כל ביקורת נפתחת בשבע בדיקות קבועות: מה רואה זחלן שלא מריץ JavaScript, זהות לכל עמוד, robots ומפת אתר, נתונים מובנים, עמודים יתומים, משקל ומהירות, ומה מתקנים קודם. מי שעובד בצ׳אט של קלוד ולא ב-Claude Code, יכול להדביק אותן ידנית מתוך [PROMPTS.md](PROMPTS.md).
